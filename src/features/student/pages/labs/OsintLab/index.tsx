            ...
            return (
              <div key={index} className={`rounded-2xl border p-6 transition-all ${
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="px-2 py-0.5 rounded bg-white/5 text-[9px] font-mono text-text-muted">{step.tool}</span>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="rounded-2xl border border-accent/30 bg-accent/5 p-6">
                ...
                {flagStatus === 'incorrect' && (
                  <div className="flex items-center gap-2 mt-3 text-sm text-red-400 font-mono"><AlertTriangle className="w-4 h-4" />Incorrect flag. Review your recon results.</div>
                )}
              </div>
            </div>
          </>
