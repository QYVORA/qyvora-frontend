                  ...
                  <AnimatePresence initial={false} custom={direction} mode="wait">
                    ...
                    >
                      <a
                        ...
                        className="group flex flex-col lg:flex-row w-full overflow-hidden rounded-2xl border border-border bg-bg-card transition-all duration-500 hover:border-accent/40 hover:shadow-[0_0_30px_rgba(102,184,112,0.06)]"
                      >
                        {current.imageUrl && (
