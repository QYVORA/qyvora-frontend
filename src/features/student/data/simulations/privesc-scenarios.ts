      ...
      chapters: [
        {
          ...
          narrative: `Valkyrie: "We have a low-privilege login on this staging server. Start by checking your surroundings."`,
        ...
        },
        {
          ...
          narrative: `"Good. Let's check for misconfigured files. The admin notes mention a tool named 'find' with SUID permissions. If this is active, it runs commands as root. Let's locate it."`,
        ...
        },
        {
          ...
          narrative: `"Bingo! The SUID bit is set on 'find'. Since 'find' has a run flag (-exec), you can use it to execute commands as root. Run it to get root and read the flag file."`,
      ...
      chapters: [
        {
          ...
          narrative: `You're logged in as 'analyst'. Let's see what commands you can run as root by typing: sudo -l`,
        ...
        },
        {
          ...
          narrative: `"Excellent. Sudo rules allow you to run vim as root without a password. Since it's run as root, we can use it to escape."`,
        ...
        },
        {
          ...
          narrative: `"Vim is running. Use the escape command :! to run cat /root/flag.txt directly from the editor."`,
          triggers: [{ type: 'file_access', value: '/root/flag.txt' }],
      ...
      chapters: [
        {
          ...
          narrative: `Valkyrie: "This is an old server. Let's inspect the system scheduler in /etc/crontab to find scheduled tasks."`,
        ...
        },
        {
          ...
          narrative: `"Found it. A cleanup script runs as root every minute, and it is world-writable. We can edit this script."`,
        ...
        },
        {
          ...
          narrative: `"Let's overwrite the cleanup script to copy the root flag to a file we can read."`,
        ...
        },
        {
          ...
          narrative: `"Wait one minute for the scheduler to run the script as root, then read the flag output."`,
      ...
      chapters: [
        {
          ...
          narrative: `Let's check the permissions on the system user file at /etc/passwd.`,
        ...
        },
        {
          ...
          narrative: `"The file is world-writable. We can add a new user with root access. First, generate a password hash."`,
        ...
        },
        {
          ...
          narrative: `"Now, append a new user 'pwned' with UID 0 (root privileges) to /etc/passwd."`,
        ...
        },
        {
          ...
          narrative: `"Switch to the 'pwned' user and read the flag at /root/flag.txt."`,
          triggers: [{ type: 'file_access', value: '/root/flag.txt' }],
      ...
      chapters: [
        {
          ...
          narrative: `This server is old. Let's check the kernel version using uname -a.`,
        ...
        },
        {
          ...
          narrative: `"Kernel 3.13.0 is vulnerable to CVE-2015-1328. Let's check if we have GCC installed to compile the exploit."`,
        ...
        },
        {
          ...
          narrative: `"GCC is ready. Compile the exploit C code now."`,
        ...
        },
        {
          ...
          narrative: `"Run the compiled exploit to get root privileges."`,
        ...
        },
        {
          ...
          narrative: `"We have root! Read the flag in /root/flag.txt."`,
          triggers: [{ type: 'file_access', value: '/root/flag.txt' }],
      ...
      chapters: [
        {
          ...
          narrative: `Let's check the system capabilities using getcap.`,
        ...
        },
        {
          ...
          narrative: `"Python3 has cap_setuid capabilities, which means it can change its user ID to root."`,
        ...
        },
        {
          ...
          narrative: `"Run a Python command that sets the UID to 0 and spawns a bash shell."`,
        ...
        },
        {
          ...
          narrative: `"You are root now. Read the flag in /root/flag.txt."`,
          triggers: [{ type: 'file_access', value: '/root/flag.txt' }],
          hint: 'Read the flag: cat /root/flag.txt',
        },
      ],
      ...
      chapters: [
        {
          ...
          narrative: `Let's read the backup script that runs as root.`,
        ...
        },
        {
          ...
          narrative: `"The script calls the 'backup' command without an absolute path. We can hijack this."`,
          triggers: [{ type: 'command', value: 'cat' }, { type: 'output_contains', value: 'backup --' }],
        ...
        },
        {
          ...
          narrative: `"Create a fake 'backup' script in your home bin folder that reads the root flag."`,
        ...
        },
        {
          ...
          narrative: `"Add your bin folder to the front of PATH and run the backup script."`,
        ...
        },
        {
          ...
          narrative: `"The script executed your fake backup utility as root. Read the flag output."`,
      ...
      chapters: [
        {
          ...
          narrative: `Let's check your group memberships with the id command.`,
        ...
        },
        {
          ...
          narrative: `"You are in the docker group, which allows you to run containers as root. Let's mount the host drive."`,
        ...
        },
        {
          ...
          narrative: `"Run an Alpine container and mount the host root directory (/) to /mnt."`,
        ...
        },
        {
          ...
          narrative: `"Use chroot to enter /mnt and read the flag at /root/flag.txt."`,
          triggers: [{ type: 'file_access', value: '/root/flag.txt' }],
      ...
      chapters: [
        {
          ...
          narrative: `Valkyrie: "Let's check the NFS configuration in /etc/exports."`,
        ...
        },
        {
          ...
          narrative: `Valkyrie: "The share /srv/nfs/data has no_root_squash. This means root on the client is root on the server."`,
        ...
        },
        {
          ...
          narrative: `Valkyrie: "Create an exploit program on the share and set the SUID permissions."`,
        ...
        },
        {
          ...
          narrative: `Valkyrie: "On the server, run the SUID program to spawn a root shell."`,
        ...
        },
        {
          ...
          narrative: `Valkyrie: "You have root! Read the flag at /root/flag.txt."`,
          triggers: [{ type: 'file_access', value: '/root/flag.txt' }],
          hint: 'Read the flag: cat /root/flag.txt',
        },
      ],
      ...
      chapters: [
        {
          ...
          narrative: `Let's check the permissions on the shared folder.`,
        ...
        },
        {
          ...
          narrative: `"The folder is writable but missing the sticky bit. This means we can delete any file inside it."`,
        ...
        },
        {
          ...
          narrative: `"Delete the temporary scratch file and replace it with a symlink to /root/flag.txt."`,
        ...
        },
        {
          ...
          narrative: `"Wait for the root cron job to read the file."`,
        ...
        },
        {
          ...
          narrative: `"The cron job followed your symlink and copied the flag into the public log. Read the log."`,
