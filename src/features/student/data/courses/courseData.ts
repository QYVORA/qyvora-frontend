...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    coverSvg: `data:image/svg+xml,${encodeURIComponent(
      `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250"><rect width="400" height="250" fill="#0a0e0a"/><rect x="20" y="20" width="360" height="210" rx="6" fill="#1a1e1a" stroke="#4ade80" stroke-width="1"/><text x="30" y="55" fill="#888" font-family="monospace" font-size="11">$ nmap -sV 192.168.1.0/24</text><text x="30" y="80" fill="#4ade80" font-family="monospace" font-size="11">Nmap scan report for 192.168.1.1</text><text x="30" y="100" fill="#888" font-family="monospace" font-size="10">22/tcp  open  ssh     OpenSSH 8.9p1</text><text x="30" y="120" fill="#888" font-family="monospace" font-size="10">80/tcp  open  http    Apache 2.4.57</text><text x="30" y="140" fill="#888" font-family="monospace" font-size="10">443/tcp open  https   Apache 2.4.57</text><text x="30" y="160" fill="#888" font-family="monospace" font-size="10">8080/tcp open http-proxy</text><text x="30" y="185" fill="#4ade80" font-family="monospace" font-size="11">Nmap done: 256 hosts scanned</text></svg>`
    )}`,
    estimatedMinutes: 60,
    cpCost: 75,
    learningObjectives: [
