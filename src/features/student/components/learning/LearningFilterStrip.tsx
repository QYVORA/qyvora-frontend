...
const LearningFilterStrip: React.FC<LearningFilterStripProps> = ({
  ...
  return (
    <div className="border border-border/30 rounded-xl bg-bg-card p-1.5 flex items-center gap-1 overflow-x-auto no-scrollbar">
      {filters.map((filter) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${
              isActive
