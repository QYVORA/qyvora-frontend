  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 pb-16 ${totalSteps <= 5 ? 'md:justify-end' : ''}`}>
      <button
        ...
        className="inline-flex items-center gap-2 bg-bg-card border border-border text-text-muted hover:bg-accent-dim hover:text-accent font-bold uppercase tracking-[0.08em] rounded-xl px-5 py-2.5 transition-all"
      >
      ...
      <button
        ...
        className="md:hidden bg-bg-card border border-border text-text-muted hover:bg-accent-dim hover:text-accent font-bold uppercase tracking-[0.08em] rounded-xl px-5 py-2.5 transition-all inline-flex flex-1 items-center justify-center gap-2 disabled:opacity-30 sm:flex-none"
      >
      ...
      <button
        ...
        disabled={completing}
        className={`inline-flex flex-1 md:flex-none items-center justify-center gap-2 sm:flex-none font-bold uppercase tracking-[0.08em] rounded-xl border border-accent/20 px-7 py-3 transition-all ${
          isLastStep
