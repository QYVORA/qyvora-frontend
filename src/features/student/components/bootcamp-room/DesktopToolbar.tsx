  ...
  return (
    ...
    >
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-lg bg-bg-card border border-border text-text-muted hover:text-accent hover:border-accent/50 active:scale-95 transition-colors"
      >
      ...
      <button
        ...
        className={`flex h-9 w-9 items-center justify-center rounded-lg border transition-colors ${
          isLastStep
            ...
            : 'bg-bg-card border-border text-text-muted hover:text-accent hover:border-accent/50 active:scale-95'
