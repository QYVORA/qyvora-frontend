          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 shrink-0 rounded-xl overflow-hidden flex items-center justify-center border-2 border-accent bg-black">
            ...
            <div className="p-2">
              ...
              >
                <div className="relative w-8 h-8 rounded-lg bg-bg-elevated border border-border/30 flex items-center justify-center shrink-0 group-hover:border-accent/30 group-hover:bg-accent/10 transition-colors">
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 min-w-3.5 h-3.5 px-1 bg-accent text-on-accent text-[7px] font-black rounded-full flex items-center justify-center leading-none">
