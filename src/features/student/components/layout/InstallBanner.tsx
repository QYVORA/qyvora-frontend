    ...
    <AnimatePresence>
      {isInstallable() && !dismissed && managerVisible && (
        <motion.div
          ...
          className="fixed bottom-20 md:bottom-6 left-4 right-4 md:left-auto md:right-6 md:max-w-sm z-[140] pb-[env(safe-area-inset-bottom,0px)]"
        >
          <div className="bg-bg-card/95 backdrop-blur-xl border border-border/50 rounded-2xl p-4 shadow-2xl">
            <div className="flex items-start gap-3">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  disabled={installing}
                  className="px-3 py-1.5 rounded-2xl bg-accent text-on-accent text-[10px] font-black uppercase tracking-widest hover:brightness-110 transition-all disabled:opacity-50"
                >
