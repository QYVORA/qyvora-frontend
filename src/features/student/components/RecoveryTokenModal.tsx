          ...
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="relative mb-8 flex justify-center">
                ...
                <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border-2 border-yellow-500/40 bg-bg-card/80 backdrop-blur-xl text-yellow-500 shadow-[0_0_30px_rgba(234,179,8,0.2)]">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="h-1 w-20 bg-yellow-500/40 mx-auto rounded-full" />
              </div>
              
              <p className="text-sm font-mono text-text-muted leading-relaxed mb-10 max-w-[320px] mx-auto">
                We do not have a centralized password reset system. 
                <span className="text-text-primary block mt-2">Your recovery token is the ONLY way to regain access if you lose your password.</span>
              </p>
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500 w-full">
              <div className="relative mb-8 flex justify-center">
                ...
                <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border-2 border-accent/40 bg-bg-card/80 backdrop-blur-xl text-accent">
              ...
              <div className="relative mb-10 group">
                ...
                <div className="relative bg-bg border border-border rounded-xl p-4 font-mono text-sm break-all text-accent select-all">
                  {token || 'INITIALISING...'}
                </div>
                <button
                  onClick={handleCopy}
          ...
          {step === 3 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500 w-full">
              <div className="relative mb-8 flex justify-center">
                ...
                <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border-2 border-green-500/40 bg-bg-card/80 backdrop-blur-xl text-green-500">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="h-1 w-20 bg-green-500/40 mx-auto rounded-full" />
              </div>
              
              <p className="text-sm font-mono text-text-muted leading-relaxed mb-8">
