            ...
            <tbody className="divide-y divide-border/20">
              {products.map(item => (
                <tr key={item._id} className="hover:bg-accent-dim/5 transition-colors group">
                   <td className="px-6 py-6"><div className="w-16 h-16 rounded-xl overflow-hidden border border-border/60 shadow-lg group-hover:scale-[1.05] transition-transform duration-500"><AuthImage src={item.coverUrl} alt={item.title} width={64} height={64} className="w-full h-full object-cover" loading="lazy" /></div></td>
