    ...
    },
    {
      ...
      render: (item) => (
        item.lastLoginAt ? (
          ...
          <span className="text-xs font-black uppercase text-text-muted/40 tracking-widest">{t('admin.users.neverLoggedIn')}</span>
        )
      ),
    },
    {
    ...
    },
    {
      ...
      render: (item) => (
        item.recoveryToken ? (
          ...
          <span className="text-xs font-black uppercase text-text-muted/40 tracking-widest">{t('common2.na')}</span>
        )
      ),
    },
    {
    ...
    <div className="bg-transparent space-y-4">
      <div>
        ...
        {item.lastLoginAt ? (
          ...
          <div className="mt-3 text-xs font-black uppercase text-text-muted/40 tracking-widest">{t('admin.users.neverLoggedIn')}</div>
        )}
        {item.recoveryToken && (
