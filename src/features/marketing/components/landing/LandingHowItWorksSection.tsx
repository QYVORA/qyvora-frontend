            ...
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-2xl md:rounded-3xl border border-border/30 bg-accent-dim min-h-[35svh] md:min-h-[30svh]">
                <AnimatePresence mode="wait" custom={direction}>
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-bg-card via-bg-card to-transparent dark:hidden" />
                    <div
                      className="absolute inset-0 hidden dark:block bg-cover bg-center"
                      style={{ backgroundImage: `url(${step.bgImage})` }}
                    />
                    <div className="absolute inset-0 hidden dark:block bg-gradient-to-r from-bg-card via-bg-card/60 to-transparent" />
