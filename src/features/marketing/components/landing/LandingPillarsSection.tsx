...
const LandingPillarsSection: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden min-h-dvh flex flex-col">
      <div className="relative w-full flex-1 min-h-0 px-3 md:px-4 lg:px-6 pt-20 md:pt-24 lg:pt-28 pb-6 md:pb-8 lg:pb-10 flex flex-col">
        <div className="w-full flex-1 flex flex-col min-h-0">
          {/* Bento grid: 2-col on mobile (QuiteRoot-style), 4 columns on desktop */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 flex-1 auto-rows-fr">
              ...
              >
                ...
                <div className="relative h-full flex flex-col">
                  <div className="flex items-center justify-between mb-3 sm:mb-6 gap-2">
                    <div className="w-9 h-9 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center shrink-0 bg-accent/10 border border-accent/20">
                      <featured.icon size={20} className="text-accent sm:w-7 sm:h-7" />
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest px-2.5 sm:px-4 py-1 sm:py-1.5 rounded-full border border-accent/30 bg-accent/10 text-accent truncate">
                      {featured.stat}
                    </span>
                  </div>
