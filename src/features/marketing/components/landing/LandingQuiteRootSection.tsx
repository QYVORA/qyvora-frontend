...
const LandingQuiteRootSection = () => {
  ...
  return (
    <div className="relative bg-bg min-h-dvh flex flex-col overflow-hidden" >
      ...
      <div className="relative z-10 w-full flex-1 min-h-0 px-3 md:px-4 lg:px-6 py-12 sm:py-10 md:py-16 lg:py-20 flex flex-col gap-12 lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-12 xl:gap-16 lg:items-center">
