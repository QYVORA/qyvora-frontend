...
const LandingHeroSection: React.FC<LandingHeroSectionProps> = ({
  ...
  return (
    <div ref={heroRef} className="relative w-full h-full min-h-dvh overflow-hidden flex flex-col bg-bg" data-nav-invert>
        ...
        ">
          ...
          <div className="flex flex-col items-start w-full space-y-8 sm:space-y-10">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 border border-border/50 bg-bg-elevated/50 dark:backdrop-blur-sm backdrop-blur-none rounded-lg max-w-full shadow-[0_0_15px_rgba(0,0,0,0.05)]"
            >
