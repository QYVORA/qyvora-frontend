...
export const MARKETING_SERVICES: MarketingService[] = [
  {
    ...
    icon: Shield,
    img: '/assets/sections/services/corporate-security-assessment.webp',
  ...
  },
  {
    ...
    icon: UserCheck,
    img: '/assets/sections/services/employee-security-training.webp',
  ...
  },
  {
    ...
    icon: Wrench,
    img: '/assets/sections/services/proprietary-security-tooling.webp',
  ...
  },
  {
    ...
    icon: BrainCircuit,
    img: '/assets/sections/services/ai-integrated-solutions.webp',
