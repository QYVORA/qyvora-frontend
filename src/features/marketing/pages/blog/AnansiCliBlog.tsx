...
const CodeBlock = ({ code }: { code: string }) => (
  <div className="bg-[#050505] border border-white/10 rounded-xl overflow-hidden my-8">
    <div className="bg-[#121212] border-b border-white/5 px-4 py-3 flex items-center gap-2.5">
      <div className="w-3 h-3 rounded-full bg-[#ff5f56]" />
      <div className="w-3 h-3 rounded-full bg-[#ffbd2e]" />
      <div className="w-3 h-3 rounded-full bg-[#27c93f]" />
      <span className="ml-4 text-[9px] font-mono text-white/30 uppercase tracking-widest">terminal</span>
    </div>
    <pre className="p-4 md:p-6 overflow-x-auto text-xs md:text-sm font-mono leading-relaxed text-white/90">
      <code>{code}</code>
    </pre>
  </div>
);
...
const PhaseCard = ({ icon: Icon, name, desc }: { icon: React.ElementType; name: string; desc: string }) => (
...
const OutputBlock = ({ text }: { text: string }) => (
  <div className="bg-[#050505] border border-white/10 rounded-xl overflow-hidden my-8">
    <div className="bg-[#121212] border-b border-white/5 px-4 py-3 flex items-center gap-2.5">
      <div className="w-3 h-3 rounded-full bg-[#ff5f56]" />
      <div className="w-3 h-3 rounded-full bg-[#ffbd2e]" />
      <div className="w-3 h-3 rounded-full bg-[#27c93f]" />
      <span className="ml-4 text-[9px] font-mono text-white/30 uppercase tracking-widest">output</span>
    </div>
    <pre className="p-4 md:p-6 overflow-x-auto text-xs md:text-sm font-mono leading-relaxed text-white/80 whitespace-pre">
      <code>{text}</code>
    </pre>
  </div>
);
