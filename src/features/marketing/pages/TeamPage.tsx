...
const TeamPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-bg flex flex-col justify-between overflow-x-hidden">
      <SEO 
      ...
      {/* ── MAIN CONTENT AREA ── */}
      <div className="relative z-10 w-full flex-1 flex flex-col justify-center pt-32 pb-20 px-4 sm:px-6 md:px-10 max-w-[1600px] mx-auto">
        ...
        <ScrollReveal>
          <div className="flex flex-col items-center justify-center mb-16 text-center">
            ...
            <SimpleHeading text="THE TEAM" compact />
          </div>
        </ScrollReveal>
