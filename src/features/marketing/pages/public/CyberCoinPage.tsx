...
const SectionHeader: React.FC<SectionHeaderProps> = ({ kicker, title, description, align = 'left' }) => (
...
const SnapSection: React.FC<{ id?: string; className?: string; children: React.ReactNode }> = ({
  id,
  className = '',
  children,
}) => (
  ...
  return (
    <div className="bg-bg min-h-full">
      ...
      <PublicSnapLayout>
        ...
        {/* ── 02 · WHAT IS CP ───────────────────────────────────────────── */}
        <SnapSection id="what-is-cp" className="bg-bg-alt">
              ...
              {CP_PILLARS.map((pillar, i) => {
                ...
                return (
                  <ScrollReveal key={pillar.id} delay={i * 0.08}>
                    <div className="terminal-card group relative h-full rounded-2xl border border-border/30 bg-bg-card p-5 md:p-6 transition-colors duration-300 hover:border-accent/40">
        ...
        {/* ── 03 · PHILOSOPHY ───────────────────────────────────────────── */}
        <SnapSection id="philosophy" className="bg-bg">
          <div className="space-y-8 lg:space-y-10">
            <ScrollReveal>
              <SectionHeader
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-stretch">
              ...
              <ScrollReveal direction="right" className="h-full">
                <div className="relative h-full rounded-2xl border border-border/30 bg-bg-card p-5 md:p-7">
              ...
              <ScrollReveal direction="left" className="h-full">
                <div className="h-full rounded-2xl border border-border/30 bg-bg-card overflow-hidden flex flex-col">
        ...
        {/* ── 04 · HOW YOU EARN CP (the one earning section) ───────────── */}
        <SnapSection id="earn" className="bg-bg-alt">
          <div className="space-y-8 lg:space-y-10">
            <ScrollReveal>
              <SectionHeader
            ...
            {/* Reward matrix */}
            <ScrollReveal>
              <div className="wc-table mx-auto rounded-2xl border border-border/30 bg-bg-card overflow-hidden">
                {/* Header row */}
                <div className="hidden sm:grid grid-cols-[1.5fr_1fr_120px_150px] gap-4 px-5 md:px-6 py-3.5 border-b border-border/30 bg-bg-elevated">
        ...
        {/* ── 05 · CP × ANANSI CLI ──────────────────────────────────────── */}
        <SnapSection id="anansi" className="bg-bg">
        ...
        {/* ── 06 · FUTURE / BLOCKCHAIN LAYER ────────────────────────────── */}
        <SnapSection id="future" className="bg-bg">
          <div className="space-y-8 lg:space-y-10">
            <ScrollReveal>
              <SectionHeader
