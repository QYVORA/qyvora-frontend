...
const RoomSection: React.FC<RoomSectionProps> = ({ room, roomIndex }) => {
  ...
  return (
    <article className="relative rounded-2xl border border-border/30 bg-bg-card p-5 md:p-8 lg:p-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-6">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <h3 className="text-lg md:text-2xl font-black text-text-primary tracking-tight leading-tight break-words">
              {room.title}
            </h3>
          </div>
        </div>
