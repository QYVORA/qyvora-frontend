...
const ShakaPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          <Callout
            ...
            title="Assess only authorized directories"
            className="lg:self-start"
          >
            shaka assesses only explicitly authorized directory targets. Live targets require explicit
            authorization (--authorized/-y, config, or QYVORA_AUTHORIZED=true); the built-in demo
            directory is auto-authorized for safe offline exploration.
          </Callout>
      ...
      <DocFooterNav currentPath="/shaka" />
    </ToolDocPage>
  );
};
