...
const WalkthroughPage = lazy(() => import('../features/student/pages/WalkthroughPage'));
    ...
    <AnimatePresence mode="wait">
      <Routes location={location}>
        ...
        <Route element={<StudentLayout />}>
          ...
          <Route path="/bootcamps/:bootcampId/walkthrough" element={<Wrap scope="Walkthrough"><StudentOnly><WalkthroughPage /></StudentOnly></Wrap>} />
