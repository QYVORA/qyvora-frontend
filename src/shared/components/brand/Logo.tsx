...
const Logo: React.FC<LogoProps> = ({ className = '', size = 'md', variant = 'full', color = 'var(--color-accent)' }) => {
  if (variant === 'mark') {
    return (
...
export const QyvoraLogo: React.FC<{ className?: string; color?: string }> = ({ className = '', color = 'var(--color-accent)' }) => {
  return (
