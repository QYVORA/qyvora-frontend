      ...
      <DialogContent title={course.title} maxWidth="max-w-lg">
        <div className="space-y-5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-surface-raised rounded-lg text-xs font-black uppercase tracking-widest text-text-muted border border-border-subtle">
