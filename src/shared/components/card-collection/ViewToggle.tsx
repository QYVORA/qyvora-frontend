    ...
    {VIEW_OPTIONS.map(({ mode, label: buttonLabel, Icon }) => {
      ...
      return (
        <button
          ...
          className={`flex items-center justify-center w-7 h-7 rounded-lg transition-[background-color,color,transform] duration-[var(--dur-fast)] active:scale-95 disabled:opacity-50 disabled:pointer-events-none ${
            isActive
