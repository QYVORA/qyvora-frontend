...
export function StatCard({ label, value, sub, icon: Icon, trend, color, className }) {
  return (
    <div className={clsx('card p-5 flex items-start gap-4', className)}>
      ...
      <div className="min-w-0">
        ...
        <p className="font-display font-bold text-2xl text-[var(--text-primary)] mt-1">{value}</p>
