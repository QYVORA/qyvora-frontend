...
>(({ className, ariaLabel, children, ...props }, ref) => (
  <RadixDialog.Portal>
    <RadixDialog.Overlay
      className={cn(
        'fixed inset-0 z-[120] lg:hidden bg-black/70',
    ...
    <RadixDialog.Content
      ...
      className={cn(
        'fixed bottom-0 left-0 right-0 z-[130] lg:hidden',
        'bg-surface border-t border-border-subtle rounded-t-2xl max-h-[82svh] overflow-y-auto',
        'outline-none',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
